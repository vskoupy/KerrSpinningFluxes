...
CorrectionSpherical[orbitGeo_,kmax_?EvenQ]:=Module[{a,p,e,x,\[ScriptCapitalI],\[ScriptCapitalR]tfunc,\[ScriptCapitalR]\[Phi]func,\[ScriptCapitalF]\[GothicR]func,\[ScriptCapitalG]\[GothicR]func,\[ScriptCapitalG]\[Theta]func,\[ScriptCapitalH]\[GothicR]func,\[ScriptCapitalH]\[Theta]func,\[ScriptCapitalI]1\[Theta]func,\[ScriptCapitalI]2func,
  ...
  Z[z_]:=Qhat-z^2*(a^2*(1-Ehat^2)*(1-z^2)+Lzhat^2+Qhat);
  \[Chi]\[Theta]hat[\[Lambda]\[Theta]_]:=\[Chi]\[Theta]hat[\[Lambda]\[Theta]]=If[Mod[\[Lambda]\[Theta],2Pi/\[CapitalUpsilon]\[Theta]hat]<Pi/\[CapitalUpsilon]\[Theta]hat,ArcCos[Cos[orbitGeo["Trajectory"][[3]][\[Lambda]\[Theta]]]/Sin[\[ScriptCapitalI]]]+2Pi*Floor[\[Lambda]\[Theta]/(2Pi/\[CapitalUpsilon]\[Theta]hat)],2Pi+2Pi*Floor[\[Lambda]\[Theta]/(2Pi/\[CapitalUpsilon]\[Theta]hat)]-ArcCos[Cos[orbitGeo["Trajectory"][[3]][\[Lambda]\[Theta]]]/Sin[\[ScriptCapitalI]]]];
  \[Delta]udst[\[Lambda]\[Theta]_]:=\[Delta]udst[\[Lambda]\[Theta]]=Re[Sum[If[k==0,0,Im[\[ScriptCapitalR]tfour[[k+kmax+1]]]/(-k*\[CapitalUpsilon]\[Theta]hat)*Exp[-I*k*\[CapitalUpsilon]\[Theta]hat*\[Lambda]\[Theta]]],{k,-kmax,kmax,2}]];(* definition of \[Delta]udst summed over even k for aligned spin *)
  \[Delta]uds\[Phi][\[Lambda]\[Theta]_]:=\[Delta]uds\[Phi][\[Lambda]\[Theta]]=Re[Sum[If[k==0,0,Im[\[ScriptCapitalR]\[Phi]four[[k+kmax+1]]]/(-k*\[CapitalUpsilon]\[Theta]hat)*Exp[-I*k*\[CapitalUpsilon]\[Theta]hat*\[Lambda]\[Theta]]],{k,-kmax,kmax,2}]];
  \[ScriptCapitalR]tfunc[r_,z_,drd\[Lambda]_,dzd\[Lambda]_]:=-((2 a^2 dzd\[Lambda] r z (3 r^2 (2 Khat+r^2)-2 a^2 (3 Khat+4 r^2) z^2+a^4 z^4)+drd\[Lambda] (3 Khat r^4-9 a^2 r^2 (2 Khat+r^2) z^2+a^4 (3 Khat+14 r^2) z^4-a^6 z^6))/(Sqrt[Khat] (r^2+a^2 z^2)^4));(* functionf for t and \[Phi] equations *)
  \[ScriptCapitalR]\[Phi]func[r_,z_,drd\[Lambda]_,dzd\[Lambda]_]:=-((a (-2 dzd\[Lambda] r (a^2+r^2) z (3 r^2 (2 Khat+r^2)-2 a^2 (3 Khat+4 r^2) z^2+a^4 z^4)+drd\[Lambda] (-1+z^2) (3 Khat r^4-9 a^2 r^2 (2 Khat+r^2) z^2+a^4 (3 Khat+14 r^2) z^4-a^6 z^6)))/(Sqrt[Khat] (r^2+a^2 z^2)^4));
  \[ScriptCapitalF]\[GothicR]func[]:=1;
  \[ScriptCapitalG]\[GothicR]func[r_,z_,drd\[Lambda]_]:=(-((2 (-1+r))/(a^2+(-2+r) r))-(2 r)/(r^2+a^2 z^2))*drd\[Lambda];
  ...
  ExpjkTable=Table[N[Exp[2Pi*I*k*(j-1/2)/steps\[Theta]],Precision[{a,p,e,x}]],{j,1,steps\[Theta]},{k,-kmax,kmax}];
  Print["Calculating t, \[Phi] equations"];
  \[ScriptCapitalR]tlist=Table[\[ScriptCapitalR]tfunc[p,zhat[\[Lambda]\[Theta]],0,dzd\[Lambda][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];(* list of values of \[ScriptCapitalR]t for Fourier transform *)
  \[ScriptCapitalR]\[Phi]list=Table[\[ScriptCapitalR]\[Phi]func[p,zhat[\[Lambda]\[Theta]],0,dzd\[Lambda][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  ...
  Print["Calculating r equation"];
  \[ScriptCapitalF]\[GothicR]list=Table[\[ScriptCapitalF]\[GothicR]func[],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalG]\[GothicR]list=Table[\[ScriptCapitalG]\[GothicR]func[p,zhat[\[Lambda]\[Theta]],0],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalG]\[Theta]list=Table[\[ScriptCapitalG]\[Theta]func[p,zhat[\[Lambda]\[Theta]],dzd\[Lambda][\[Lambda]\[Theta]],\[Chi]\[Theta]hat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalH]\[GothicR]list=Table[\[ScriptCapitalH]\[GothicR]func[p,zhat[\[Lambda]\[Theta]],0,dzd\[Lambda][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalH]\[Theta]list=Table[\[ScriptCapitalH]\[Theta]func[p,zhat[\[Lambda]\[Theta]],0,dzd\[Lambda][\[Lambda]\[Theta]],\[Chi]\[Theta]hat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalI]1\[Theta]list=Table[\[ScriptCapitalI]1\[Theta]func[p,zhat[\[Lambda]\[Theta]],dzd\[Lambda][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalI]2list=Table[\[ScriptCapitalI]2func[p,zhat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalI]3list=Table[\[ScriptCapitalI]3func[p,zhat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalJ]list=Table[\[ScriptCapitalJ]func[p,zhat[\[Lambda]\[Theta]],\[Delta]udst[\[Lambda]\[Theta]],\[Delta]uds\[Phi][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  ...
  Print["Calculating \[Theta] equation"];
  \[ScriptCapitalQ]\[Theta]list=Table[\[ScriptCapitalQ]\[Theta]func[zhat[\[Lambda]\[Theta]],\[Chi]\[Theta]hat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalS]\[GothicR]list=Table[\[ScriptCapitalS]\[GothicR]func[p,zhat[\[Lambda]\[Theta]],0],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalS]\[Theta]list=Table[\[ScriptCapitalS]\[Theta]func[p,zhat[\[Lambda]\[Theta]],dzd\[Lambda][\[Lambda]\[Theta]],\[Chi]\[Theta]hat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalT]\[GothicR]list=Table[\[ScriptCapitalT]\[GothicR]func[p,zhat[\[Lambda]\[Theta]],0,dzd\[Lambda][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalT]\[Theta]list=Table[\[ScriptCapitalT]\[Theta]func[p,zhat[\[Lambda]\[Theta]],0,dzd\[Lambda][\[Lambda]\[Theta]],d2zd\[Lambda]2[zhat[\[Lambda]\[Theta]]],\[Chi]\[Theta]hat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalU]1\[Theta]list=Table[\[ScriptCapitalU]1\[Theta]func[p,zhat[\[Lambda]\[Theta]],dzd\[Lambda][\[Lambda]\[Theta]],d2zd\[Lambda]2[zhat[\[Lambda]\[Theta]]],\[Chi]\[Theta]hat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalU]2list=Table[\[ScriptCapitalU]2func[p,zhat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalU]3list=Table[\[ScriptCapitalU]3func[p,zhat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalV]list=Table[\[ScriptCapitalV]func[p,zhat[\[Lambda]\[Theta]],\[Delta]udst[\[Lambda]\[Theta]],\[Delta]uds\[Phi][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  ...
  Print["Calculating norm equation"];
  \[ScriptCapitalK]\[GothicR]list=Table[\[ScriptCapitalK]\[GothicR]func[p,zhat[\[Lambda]\[Theta]],0],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalK]\[Theta]list=Table[\[ScriptCapitalK]\[Theta]func[p,zhat[\[Lambda]\[Theta]],dzd\[Lambda][\[Lambda]\[Theta]],\[Chi]\[Theta]hat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalM]\[GothicR]list=Table[\[ScriptCapitalM]\[GothicR]func[p,zhat[\[Lambda]\[Theta]],0,dzd\[Lambda][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalM]\[Theta]list=Table[\[ScriptCapitalM]\[Theta]func[p,zhat[\[Lambda]\[Theta]],0,dzd\[Lambda][\[Lambda]\[Theta]],\[Chi]\[Theta]hat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalN]1\[Theta]list=Table[\[ScriptCapitalN]1\[Theta]func[p,zhat[\[Lambda]\[Theta]],dzd\[Lambda][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalN]2list=Table[\[ScriptCapitalN]2func[p,zhat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalN]3list=Table[\[ScriptCapitalN]3func[p,zhat[\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
  \[ScriptCapitalP]list=Table[\[ScriptCapitalP]func[p,zhat[\[Lambda]\[Theta]],\[Delta]udst[\[Lambda]\[Theta]],\[Delta]uds\[Phi][\[Lambda]\[Theta]]],{\[Lambda]\[Theta],\[CapitalLambda]\[Theta]hat/2/steps\[Theta],\[CapitalLambda]\[Theta]hat,\[CapitalLambda]\[Theta]hat/steps\[Theta]}];
